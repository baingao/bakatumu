...
package com.bakatumu.bakatumu.gcm;
...
import com.bakatumu.bakatumu.activity.ChatRoomActivity;
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // show the message in notification try in ChatRoomActivity
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // Start of tambahan
                    // show the message in notification tray
                ...
                Toast.makeText(getApplicationContext(), "Json parse error 2: " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
